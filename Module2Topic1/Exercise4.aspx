...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="fnCheck" runat="server" ControlToValidate ="fullName" ErrorMessage="Please enter your full name." InitialValue="Enter your Full Name.">
        ...
        <asp:RangeValidator ID="ageCheck" runat="server" ControlToValidate="age" ErrorMessage="Invalid Value Range"
        ...
        <asp:RegularExpressionValidator runat="server" ID="REVCheck" ControlToValidate="email"
        ...
        <asp:CompareValidator ID="emailCheck" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ValueToCompare="confirmEmail" ErrorMessage="Emails does not match."
            Operator="Equal">
